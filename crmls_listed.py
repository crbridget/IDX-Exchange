...
if token:
    ...
    params = {
        ...
        '$filter': f"ListingContractDate ge {datetime(2026, 3, 1).isoformat(timespec='milliseconds')}Z and ListingContractDate lt {datetime(2026, 4, 1).isoformat(timespec='milliseconds')}Z",
    ...
    total_records = 0
    csv_file = 'raw/CRMLSListing202603.csv'
