...
if token:
    ...
    params = {
        ...
        '$filter': f"MlsStatus eq 'Closed' and CloseDate ge {datetime(2026, 3, 1).isoformat(timespec='milliseconds')}Z and CloseDate lt {datetime(2026, 4, 1).isoformat(timespec='milliseconds')}Z",
    ...
    total_records = 0
    csv_file = 'raw/CRMLSSold202603.csv'
